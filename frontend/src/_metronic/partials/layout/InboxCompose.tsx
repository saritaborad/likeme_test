...
const InboxCompose: React.FC<Props> = ({show, handleClose}) => {
  ...
  return (
    <Modal className='modal-sticky modal-sticky-lg modal-sticky-bottom-right' id='kt_inbox_compose' role='dialog' data-backdrop='false' aria-hidden='true' tabIndex='-1' show={show} animation={false}>
